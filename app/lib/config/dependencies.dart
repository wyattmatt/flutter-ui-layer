...
import '../data/repositories/auth/auth_repository_simple.dart';
...
/// Configure dependencies with simple authentication.
/// This dependency list uses local data but requires login (accepts any credentials).
List<SingleChildWidget> get providersSimpleAuth {
  return [
    ChangeNotifierProvider.value(
      value: AuthRepositorySimple() as AuthRepository,
    ),
    Provider.value(value: LocalDataService()),
    Provider(
      create: (context) =>
